#
# spec file for package screenload on fedora, rehl, opensuse leap 15.x
#
...
URL: https://github.com/screenload-org/screenload
...
%if %{is_suse_leap}
%suse_update_desktop_file -r ru.screenload.ScreenLoad Utility X-SuSE-DesktopUtility
%endif
...
%{_bindir}/%{name}
%{_datadir}/applications/ru.screenload.ScreenLoad.desktop
%if %{is_suse_leap}
%{_datadir}/metainfo/ru.screenload.ScreenLoad.metainfo.xml
%endif
%if %{is_rhel_or_fedora}
%{_metainfodir}/ru.screenload.ScreenLoad.metainfo.xml
%endif
%{_datadir}/bash-completion/completions/%{name}
%{_datadir}/zsh/site-functions/_%{name}
%{_datadir}/fish/vendor_completions.d/%{name}.fish
%{_datadir}/dbus-1/interfaces/ru.screenload.ScreenLoad.xml
%{_datadir}/dbus-1/services/ru.screenload.ScreenLoad.service
