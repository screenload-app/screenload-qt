...
class ScreenLoadDaemon : public QObject
{
    Q_OBJECT
public:
    static void start();
    static ScreenLoadDaemon* instance();
    ...
    void sendTrayNotification(
      const QString& text,
      const QString& title = QStringLiteral("ScreenLoad Info"),
...
private:
    ...
    static ScreenLoadDaemon* m_instance;

    friend class ScreenLoadDBusAdapter;
};
