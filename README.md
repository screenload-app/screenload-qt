<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/screenload-org/screenload/blob/master/LICENSE">
      <img src="https://img.shields.io/github/license/screenload-org/screenload.svg" alt="License" />
    </a>
...
<details>
  <summary>Expand this section to see what distros are using an up to date version of screenload</summary>
  <a href="https://repology.org/metapackage/screenload/versions">
    <img src="https://repology.org/badge/vertical-allrepos/screenload.svg" alt="Packaging status">
  </a>
</details>
...
When `make` command completed you can launch screenload from `project_folder/build/src` folder
